...
def your_turn(name: str, id_X: str, message_id_X: str, id_O: str, message_id_O: str, inline_id: str) -> InlineKeyboardMarkup:
    ...
    return markup.add(InlineKeyboardButton('Ходи', callback_data="your_turn"), InlineKeyboardButton('Сдаться', callback_data="surrender"))


def not_your_turn(name: str, id_X: str, message_id_X: str, id_O: str, message_id_O: str, inline_id: str, date: int|None = None) -> InlineKeyboardMarkup:
    # id - 1, id - 2, message_id-1, message_id-2, name, time?
    # alfabet = {1: 'q', 2: 'w', 3: 'e', 4: 'r', 5: 't', 6: 'y', 7: 'u', 8: 'i', 9: 'O'}
    markup = InlineKeyboardMarkup()
    markup.add(
    ...
    if date!=None:
        buf=str(date)
    return markup.add(InlineKeyboardButton('Ходи', callback_data="hurry_up"+buf), InlineKeyboardButton('Сдаться', callback_data="surrender"))
